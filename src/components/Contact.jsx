      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
          <div className="lg:mb-0 mb-10">
            <div className="group w-full h-full">
              <div className="relative h-full">
                ...
                />
                <h1 className=" text-white text-4xl font-bold leading-10 absolute top-11 left-11">Contact us</h1>
                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                  <div className="bg-white rounded-lg p-6 block">
                    ...
                    <a href="javascript:;" className="flex items-center mb-6">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">cr@techmagnet.com</h5>
                    </a>
                    <a href="javascript:;" className="flex items-center">
                      ...
                      <h5 className="text-black text-base font-normal leading-6 ml-5">123 Main Street, Anytown, NY 12345, United States.</h5>
                    </a>
                  </div>
                </div>
              </div>
          ...
          <div className=" p-5 lg:p-11">
            <h2 className="text-4xl font-semibold leading-10 mb-11" style={{background: "-webkit-linear-gradient(45deg, #801eb2, #f73d91)","-webkit-background-clip": "text","-webkit-text-fill-color": "transparent"}}>Send Us A Message</h2>
            ...
            <div className="mb-10">
              ...
              <div className="flex">
                <div className="flex items-center mr-11">
                  <input id="radio-group-1" type="radio" name="radio-group" className="checked:bg-no-repeat checked:bg-center checked:border-indigo-500 checked:bg-indigo-100" />
                  <label htmlFor="radio-group-1" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                    <span className="ml-2"></span> Email
                  </label>
                </div>
                <div className="flex items-center">
                  <input id="radio-group-2" type="radio" name="radio-group" className="checked:bg-no-repeat checked:bg-center checked:border-indigo-500 checked:bg-indigo-100" />
                  <label htmlFor="radio-group-2" className="flex items-center cursor-pointer text-gray-500 text-base font-normal leading-6">
                    <span className=" ml-2"></span> Phone
                  </label>
                </div>
              </div>
            </div>
            ...
            <button className="w-full h-12 text-white lg:text-xl bg-gradient-to-r from-[#f73d91] to-[#801eb2]  py-3 px-16 rounded-full font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">Send</button>
          </div>
        </div>
      </div>
    </section>
