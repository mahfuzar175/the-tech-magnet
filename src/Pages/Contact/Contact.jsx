...
const Contact = () => {
  return (
    <div className="font-quicksand">
        <div className="w-full h-[400px] bg-center bg-cover mt-12" style={{backgroundImage: `url(${contact})`}}>
  <div className="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50 py-12">
    <div className="text-center">
      <div className="container px-4 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="mt-8 mb-6 text-4xl lg:text-6xl font-bold text-gray-100">Contact Us</h2>
          <p className="max-w-3xl mx-auto mb-10 text-lg text-gray-300">
           We love hearing from you! Here are some simple ways to get in touch with us...
          </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 grid-cols-1">
            ...
            <div className=" p-5 lg:p-11">
              <h2
                className="text-4xl font-semibold leading-10 mb-11"
                style={{
                  background:
              ...
              <input
                ...
                placeholder="Message"
              />
              <button className="w-full h-12 text-white lg:text-xl bg-gradient-to-r from-[#f73d91] to-[#801eb2]  py-3 px-16 rounded-full font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                Send
              </button>
            </div>
          </div>
